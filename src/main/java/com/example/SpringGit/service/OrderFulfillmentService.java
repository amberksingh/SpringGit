...
public class OrderFulfillmentService {
    ...
    public CompletableFuture<Void> notifyUser(Order order) throws InterruptedException {
        Thread.sleep(4000L);
        log.info("Notified to the user " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(null);
    }
    @Async("asyncTaskExecutor")
    public CompletableFuture<Void> assignVendor(Order order) throws InterruptedException {
        Thread.sleep(5000L);
...
//    }
    ...
    @Async("asyncTaskExecutor")
    public CompletableFuture<Void> assignDeliveryPartner(Order order) throws InterruptedException {
        Thread.sleep(4000L);
    ...
    @Async("asyncTaskExecutor")
    public CompletableFuture<Void> assignTrailerAndDispatch(Order order) throws InterruptedException {
        Thread.sleep(3000L);
